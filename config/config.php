...
class Database {
    ...
    private function insertSampleData() {
        ...
        if ($stmt->fetchColumn() == 0) {
            ...
            $horarios = [
                ['Jiu Jitsu', 'Lunes', '18:00', '19:30', 'Principiante', 1],
                ['Aikido', 'Lunes', '19:30', '21:00', 'Intermedio', 2],
                ['Judo', 'Martes', '18:00', '19:30', 'Todos los niveles', 3],
                ['Jiu Jitsu', 'Miércoles', '18:00', '19:30', 'Avanzado', 1],
                ['Aikido', 'Jueves', '18:00', '19:30', 'Principiante', 2],
                ['Judo', 'Viernes', '18:00', '19:30', 'Intermedio', 3],
                ['Jiu Jitsu', 'Sábado', '10:00', '11:30', 'Todos los niveles', 1]
            ];

            foreach ($horarios as $horario) {
                $stmt = $this->conn->prepare("INSERT INTO horarios (disciplina, dia_semana, hora_inicio, hora_fin, nivel, profesor_id) VALUES (?, ?, ?, ?, ?, ?)");
